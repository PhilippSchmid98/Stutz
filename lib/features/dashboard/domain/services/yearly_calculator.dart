...
/// Pure domain service for yearly budget vs. actual (analytics) calculations.
class YearlyCalculator {
  ...
  List<YearlyBudgetNode> buildYearlyDetail(
    ...
    final txnsInYear = allTransactions
    ...
    YearlyBudgetNode? processNode(ExpenseNode node) {
      ...
      return YearlyBudgetNode(
        ...
        offset: ownOffset + keptChildren.fold(0.0, (sum, c) => sum + c.offset),
