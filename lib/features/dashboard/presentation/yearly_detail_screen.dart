...
import 'package:stutz/features/dashboard/application/yearly_detail_provider.dart';
import 'package:stutz/features/dashboard/domain/view_models/yearly_budget_node.dart';
import 'package:stutz/features/dashboard/presentation/category_transactions_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return Stack(
          children: [
            Container(width: width, color: backgroundColor),
            Row(
              children: [
