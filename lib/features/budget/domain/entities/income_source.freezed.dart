...
class _IncomeSource extends IncomeSource {
  const _IncomeSource({required this.id, required this.name, required this.amount, this.interval = PaymentInterval.monthly, this.group = IncomeGroup.main}): super._();
